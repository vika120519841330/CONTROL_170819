...
namespace TEST_170819
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //container.RegisterType<ApplicationDbContext>(new InjectionConstructor(optionsBuilder.Options));

            //container.RegisterType<ApplicationUserManager>(new InjectionConstructor(optionsBuilder.Options));

            //container.RegisterType<ApplicationSignInManager>(new InjectionConstructor(optionsBuilder.Options));
